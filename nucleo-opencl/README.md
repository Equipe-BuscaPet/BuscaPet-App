...
[`plano-sprints-equipe-3.md`](https://github.com/Equipe-BuscaPet/Documentos/blob/main/planejamento/plano-sprints-equipe-3.md) no repositório `Documentos`). Nesta Sprint 2 o que existe é o contrato de
